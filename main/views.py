...
def defaults( request ):
	...
	params["Sekretariat"] = ( AuthUserGroups.objects.filter( user_id=request.user.id, group_id=AuthGroup.objects.get( name="Sekretariat" ).id ).count() > 0 )
...
def Baustelle( request ):
	params = {}
	params["Anrede"] = "Fremder"
	params["Sekretariat"] = False
	params["Kontostand"] = currency( 0 )
	params["options"] = {}
	params["showoptions"] = False
