...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') 
{
	...
	if (can_process())
	{
    	if ($selected_id != -1) 
    	{
    		...
    		display_notification_centered("Benutzer wurde geändert.");
    	} 
    	else 
    	{
			...
			display_notification_centered("Neuer Benutzer hinzugefügt.");
    	}
		$Mode = 'RESET';
	}
}
...
if ($Mode == 'Delete')
{
	...
	display_notification_centered("Benutzer gelöscht");
	$Mode = 'RESET';
}
...
$th = array("Benutzername (intern)", "Vollständiger Name", "Telefonnummer", "Email-Adresse", "Letzte Anmeldung")
...
text_row_ex("Volständiger Name:", 'real_name',  50);
