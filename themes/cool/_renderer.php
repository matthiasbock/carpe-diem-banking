...
***********************************************************************/
	class renderer
	{
		function wa_header()
		{
			page(_($help_context = "Klientenkonto-Server"), false, true);
		}
		...
		function menu_footer($no_menu, $is_index)
		{
			...
			if ($no_menu == false)
			{
				...
				if (isset($_SESSION['wa_current_user'])) {
					...
					echo "<td class=bottomBarCell align=right>Heute ist der " . Today() . " und es ist " . Now() . " Uhr</td>\n";
			...
			if ($no_menu == false)
			{
				...
				echo "<tr>\n";
				echo "<td align='center' class='footer'><font color='#ffffff'>Carpe Diem Berlin e.V. - Delbrückstraße 27 - 12051 Berlin - Telefon: 030 / 612 84 777 864 -  Telefax: 030 / 612 84 866</font></td>\n";
				echo "</tr>\n";
				echo "<tr>\n";
				echo "<td align='center' class='footer'><font color='#ffff00'>Zur Zeit noch online: ".show_users_online()."</font></td>\n";
				echo "</tr>\n";
