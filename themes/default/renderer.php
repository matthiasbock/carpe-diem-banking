...
//			add_js_ufile("themes/default/renderer.js");
	...
	function menu_header($title, $no_menu, $is_index)
	{
		...
		<tr><td class='quickmenu'><table width='100%' cellspacing=10>
			<tr>	<td rowspan=2>&nbsp;</td>
				<td class=logoutBarRight><a href='javascript:window.print()'><img src='$path_to_root/themes/default/images/print.png' width='48' border='0' alt='Drucken'></a></td>
				<td class=logoutBarRight><a href='$path_to_root/admin/change_current_user_password.php'><img src='$path_to_root/themes/default/images/key.png' width='48' border='0' alt='Passwort &auml;ndern'></a></td>
				<td class=logoutBarRight><a href='$path_to_root/access/logout.php'><img src='$path_to_root/themes/default/images/logout.png' height='48' border='0' alt='Abmelden'></a></td>
			</tr>
			<tr>	<td><a href='javascript:window.print()'>Seite ausdrucken</a></td>
				<td><a href='$path_to_root/admin/change_current_user_password.php'>Passwort &auml;ndern</a></td>
				<td><a href='$path_to_root/access/logout.php'>Abmelden</a></td>
			</tr>
		</table></td></tr>";
