...
if (isset($_GET['added'])) 
{
	...
	$new_value = str_replace(".", ",", $_GET['new']);
...
echo "					</select>
			...
			<tr>
				...
				<td><input name=identifier_to class=textbox size=9 maxlength=60 type=text value='Bank&uuml;berweisung'></td>
			</tr>
		</table>
	</td>
	</tr>
...
function add_transaction()
{
	...
	if ( mysql_query( "INSERT INTO bank_transactions (user,type,amount,memo,`from`,date_from,`to`,identifier_to,date_to) VALUES ('$user','GUTSCHRIFT','$amount','$memo','$from','$date_from','$to','$identifier_to','$date_to');" ) ) {
