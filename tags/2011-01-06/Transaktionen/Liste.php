	...
	for ( $i = 0; $i < 12; $i++ ) {
		...
		elseif ( $i == 2 ) { # Benutzer
			...
			$value = $name."<br/>
				...
				<a href='Liste.php?select=user&username=".urlencode($name)."'><img border=0 alt='Aktivit&auml;t' src='../themes/default/images/list.png' /></a>";
			}
		elseif ( $i == 3 ) { # Typ
...
<a href='Liste.php?select=account&account_number=$nr&account_name=".urlencode($name)."'><img border=0 alt='Aktivit&auml;t' src='../themes/default/images/list.png' />&nbsp;</a>";
				}
			}
