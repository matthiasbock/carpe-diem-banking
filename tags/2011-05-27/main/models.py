...
class Betreute(models.Model):
    ...
    startkontostand = models.FloatField(db_column='Startkontostand') # Field name made lowercase.
...
class Forderungen(models.Model):
    ...
    kreditor = models.CharField(max_length=180, db_column='Kreditor') # Field name made lowercase.
    ...
    class Meta:
        db_table = u'Forderungen'

class Geldeingaenge(models.Model):
    id = models.IntegerField(primary_key=True, db_column='ID') # Field name made lowercase.
    datum = models.DateField(db_column='Datum') # Field name made lowercase.
    geldgeber = models.CharField(max_length=180, db_column='Geldgeber') # Field name made lowercase.
    benutzer = models.IntegerField(db_column='Benutzer') # Field name made lowercase.
    betrag = models.FloatField(db_column='Betrag') # Field name made lowercase.
    verwendungszweck = models.CharField(max_length=1800, db_column='Verwendungszweck') # Field name made lowercase.
    class Meta:
        db_table = u'Geldeingaenge'
...
class Tilgungen(models.Model):
    ...
    betrag = models.FloatField(db_column='Betrag') # Field name made lowercase.
    class Meta:
        db_table = u'Tilgungen'

class Ueberweisungen(models.Model):
    id = models.IntegerField(primary_key=True, db_column='ID') # Field name made lowercase.
    betrag = models.DecimalField(decimal_places=2, max_digits=10, db_column='Betrag') # Field name made lowercase.
    betreuter = models.IntegerField(db_column='Betreuter') # Field name made lowercase.
    adressat = models.CharField(max_length=600, db_column='Adressat') # Field name made lowercase.
    verwendungszweck = models.CharField(max_length=600, db_column='Verwendungszweck') # Field name made lowercase.
    class Meta:
        db_table = u'Ueberweisungen'
