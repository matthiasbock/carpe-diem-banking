...
<a href='../Transaktionen/Liste.php?select=account&account_number=$sql2[0]'><img border=0 alt='Aktivit&auml;t' src='../themes/default/images/list.png' width=22 />&nbsp;</a>";
			}
					...
					<td>
						...
						<a href='Aktivitaet.php?user_id=$r[0]'><img border=0 alt='Aktivit&auml;t' src='../themes/default/images/list.png' width=22 /></a>
						<a href='Loeschen.php?user_id=$r[0]'><img border=0 alt='L&ouml;schen' src='../themes/default/images/delete.png' width=22 /></a>
					</td>
				</tr>\n";
		if ( $style == "evenrow" )
			$style = "oddrow";
